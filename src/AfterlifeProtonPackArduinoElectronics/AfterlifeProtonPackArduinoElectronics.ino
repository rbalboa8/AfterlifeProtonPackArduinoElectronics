...
#define GROUP 4         // How big of a group of pixels do you want to rotate?
#define INIT_SPD  255   // How slow do you want the animation to rotate at the beginning of the boot? (higher = slower, 255 max)
#define IDLE_SPD  4    // How fast do you want the animation to rotate during "normal" operation (lower = faster, 0 min)
